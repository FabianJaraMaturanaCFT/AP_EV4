...
namespace AP_EV4.Controllers
{
    public class LogsController : Controller
    {
        ...
        {
            var ejemploDbContext = _context.Logs.Include(l => l.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,UsuarioId,Accion")] Log log)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,UsuarioId,Accion")] Log log)
        {
            if (id != log.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EjemploDbContext.Logs'  is null.");
            }
            var log = await _context.Logs.FindAsync(id);
            if (log != null)
            {

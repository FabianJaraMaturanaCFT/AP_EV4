...
namespace AP_EV4.Controllers
{
    public class TareasController : Controller
    {
        ...
        public TareasController(EjemploDbContext context)
        {
            _context = context;
        }
        ...
        {
            var ejemploDbContext = _context.Tareas.Include(t => t.Proyecto).Include(t => t.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,Estado,FechaInicio,FechaFin,ProyectoId,UsuarioId")] Tarea tarea)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Estado,FechaInicio,FechaFin,ProyectoId,UsuarioId")] Tarea tarea)
        {
            if (id != tarea.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EjemploDbContext.Tareas'  is null.");
            }
            var tarea = await _context.Tareas.FindAsync(id);
            if (tarea != null)
            {

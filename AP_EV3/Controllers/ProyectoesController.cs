...
namespace AP_EV4.Controllers
{
    public class ProyectoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreProyecto,Descripcion,Cliente_proyecto,FechaDeCreacion")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,NombreProyecto,Descripcion,Cliente_proyecto,FechaDeCreacion")] Proyecto proyecto)
        {
            if (id != proyecto.Id)
            {
                return NotFound();
